...
var Swiper = (function () {
  ...
  var H = {
    ...
    updateSlides: function () {
      ...
      ("string" == typeof x && x.indexOf("%") >= 0 ? (x = (parseFloat(x.replace("%", "")) / 100) * E) : "string" == typeof x && (x = parseFloat(x)),
        ...
        s.cssMode && (m(a, "--swiper-slides-offset-before", `${f}px`), m(a, "--swiper-slides-offset-after", `${v}px`)));
      ...
      if (
        (Object.assign(e, { slides: d, snapGrid: p, slidesGrid: u, slidesSizesGrid: h }), s.centeredSlides && s.cssMode && !s.centeredSlidesBounds)
      ) {
      ...
      if (((o.allowSlidePrev = c), (o.allowSlideNext = p), o.controller && o.controller.control && !n)) {
        ...
        Array.isArray(o.controller.control)
          ? o.controller.control.forEach((e) => {
              !e.destroyed && e.params.loop && e.loopFix({ ...r, slideTo: e.params.slidesPerView === m.slidesPerView && t });
            })
          : o.controller.control instanceof o.constructor &&
            o.controller.control.params.loop &&
            o.controller.control.loopFix({ ...r, slideTo: o.controller.control.params.slidesPerView === m.slidesPerView && t });
      }
      o.emit("loopFix");
    },
    ...
    return function (s = {}) {
      ...
      "object" == typeof i && null !== i
        ? (!0 === e[a] && (e[a] = { enabled: !0 }),
          ...
          a in e && "enabled" in i
            ? ("object" != typeof e[a] || "enabled" in e[a] || (e[a].enabled = !0), e[a] || (e[a] = { enabled: !1 }), u(t, s))
            : u(t, s))
        : u(t, s);
    };
  }
  ...
  class ne {
    constructor(...e) {
      ...
      const n = {};
      r.modules.forEach((e) => {
        e({ params: s, swiper: r, extendParams: ae(s, n), on: r.on.bind(r), once: r.once.bind(r), off: r.off.bind(r), emit: r.emit.bind(r) });
      });
      const l = u({}, se, n);
      return (
        (r.params = u({}, l, re, s)),
  ...
  const be = [
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function d(t, s, a) {
        ...
        if (
          (d && y >= T ? ((M -= T), n || (P += e.slidesGrid[0])) : d && y < T && ((M = -T), n && (P += e.slidesGrid[0])),
          Object.assign(e.virtual, { from: M, to: C, offset: P, slidesGrid: e.slidesGrid, slidesBefore: T, slidesAfter: S }),
          h === M && f === C && !t)
        )
          return (
            e.slidesGrid !== w &&
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function c() {
        ...
        if (
          (e.params.loop
            ? ((d = e.previousRealIndex || 0), (i = e.params.slidesPerGroup > 1 ? Math.floor(e.realIndex / e.params.slidesPerGroup) : e.realIndex))
            : void 0 !== e.snapIndex
        ...
        ("string" == typeof t.el && e.isElement && (s = e.el.querySelector(t.el)),
          ...
          s &&
            ...
            (e.params.uniqueNavElements &&
              ...
              Array.isArray(s) &&
              s.length > 1 &&
              ((s = [...e.el.querySelectorAll(t.el)]), s.length > 1 && (s = s.find((t) => x(t, ".swiper")[0] === e.el))),
        ...
        (s &&
          ...
          s.forEach((s) => {
            (s.classList.remove(t.hiddenClass),
              ...
              t.clickable && (s.classList.remove(...(t.clickableClass || "").split(" ")), s.removeEventListener("click", d)));
          })),
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i }) {
      ...
      function C() {
        ...
        (e.params.uniqueNavElements &&
          ...
          i && ((l = i.querySelector(de(e.params.scrollbar.dragClass))), l || ((l = w("div", e.params.scrollbar.dragClass)), i.append(l))),
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: a }) {
      ...
      function k(t) {
        ...
        ((h.maxRatio = S()),
          ...
          void 0 === f.touchesStart.x && t ? ((r = t.pageX), (n = t.pageY)) : ((r = f.touchesStart.x), (n = f.touchesStart.y)));
        const z = o,
        ...
        if (
          ...
          if (e.navigation && e.navigation.prevEl && e.navigation.nextEl) {
            ...
            (M(e.navigation.nextEl).includes(a) &&
              ...
              t.includes(a) && ((e.isBeginning && !e.params.loop) || e.slidePrev(), e.isBeginning ? o(s.firstSlideMessage) : o(s.prevSlideMessage)));
          }
            ...
            requestAnimationFrame(() => {
              i ||
                (e.params.loop
                  ...
                  : a
                    ? e.slideTo(e.getSlideIndexWhenGrid(parseInt(s.getAttribute("data-swiper-slide-index"), 10)), 0)
              ...
              v() &&
                e.pagination.bullets.forEach((s) => {
                  (e.params.pagination.clickable &&
                    (d(s), e.params.pagination.renderBullet || (p(s, "button"), m(s, t.paginationBulletMessage.replace(/\{\{index\}\}/, E(s) + 1)))),
    ...
    function ({ swiper: e, extendParams: t, on: s, emit: i, params: r }) {
      ...
      function w(t) {
        e &&
          ...
          (e.wrapperEl.removeEventListener("transitionend", w), h || (t.detail && t.detail.bySwiperTouchMove) || M());
      }
      const b = () => {
        ...
        y = () => {
          ...
          const s = (() => {
            ...
            if (
              ((t =
                e.virtual && e.params.virtual.enabled ? e.slides.find((e) => e.classList.contains("swiper-slide-active")) : e.slides[e.activeIndex]),
              !t)
            )
              return;
              ...
              e &&
                ...
                (e.params.autoplay.reverseDirection
                  ? !e.isBeginning || e.params.loop || e.params.rewind
                    ...
                    : e.params.autoplay.stopOnLastSlide || (e.slideTo(e.slides.length - 1, a, !0, !0), i("autoplay"))
        ...
        M = () => {
          (e.isEnd && o < 0 && !e.params.loop) ||
            e.destroyed ||
            !e.autoplay.running ||
            ((v = new Date().getTime()), m ? ((m = !1), E(o)) : E(), (e.autoplay.paused = !1), i("autoplayResume"));
        },
        C = () => {
          if (e.destroyed || !e.autoplay.running) return;
          const t = a();
      ...
      (s("init", () => {
        ...
        s("destroy", () => {
          (e.el && "string" != typeof e.el && (e.el.removeEventListener("pointerenter", P), e.el.removeEventListener("pointerleave", L)),
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      function d(t, s) {
        ...
        else for (let t = 0; t < i; t += 1) a.slides[e.realIndex + t] && a.slides[e.realIndex + t].classList.add(r);
        (s?.autoScroll ?? 1) &&
          (function (t) {
            ...
            if (e.realIndex !== s.realIndex || r) {
              ...
              (r && (l += "next" === o ? i : -1 * i),
                s.visibleSlidesIndexes &&
                  ...
                  (s.params.centeredSlides ? (l = l > n ? l - Math.floor(a / 2) + 1 : l + Math.floor(a / 2) - 1) : l > n && s.params.slidesPerGroup,
                  s.slideTo(l, t)));
            }
          })(t ? 0 : void 0);
      }
                ...
                if (i.freeMode.momentum) {
                  ...
                  if (p < e.maxTranslate())
                    (i.freeMode.momentumBounce
                      ? (p + e.maxTranslate() < -h && (p = e.maxTranslate() - h), (u = e.maxTranslate()), (m = !0), (d.allowMomentumBounce = !0))
                      : (p = e.maxTranslate()),
                      i.loop && i.centeredSlides && (f = !0));
                  else if (p > e.minTranslate())
                    (i.freeMode.momentumBounce
                      ? (p - e.minTranslate() > h && (p = e.minTranslate() + h), (u = e.minTranslate()), (m = !0), (d.allowMomentumBounce = !0))
                      : (p = e.minTranslate()),
                      i.loop && i.centeredSlides && (f = !0));
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      ...
      (s("init", () => {
        ...
        s("update", () => {
          ...
          (n && !a
            ? (s.classList.remove(`${t.containerModifierClass}grid`, `${t.containerModifierClass}grid-column`), (r = 1), e.emitContainerClasses())
            : !n &&
              a &&
        ...
        (e.grid = {
          ...
          updateSlide: (t, s, n) => {
            ...
            if ("row" === p && o > 1) {
              ...
              "column" === p
                ? ((h = Math.floor(t / c)), (f = t - h * c), (h > r || (h === r && f === c - 1)) && ((f += 1), f >= c && ((f = 0), (h += 1))))
          ...
          p.shadow &&
            (u
              ? ((h = e.wrapperEl.querySelector(".swiper-cube-shadow")),
                ...
                (h.style.height = `${r}px`))
              : ((h = t.querySelector(".swiper-cube-shadow")), h || ((h = w("div", "swiper-cube-shadow")), t.append(h))));
          ...
          setTranslate: () => {
            ...
            for (let o = 0; o < t.length; o += 1) {
              ...
              if (y || E) {
                ...
                ((v += -28 * p * t), (g += -0.5 * t), (w += 96 * t), (h = (i.rotate || e.isHorizontal() ? -25 : 0) * t * Math.abs(p) + "%"));
              }
              if (
                ((m =
                  p < 0
              ...
              if (i.slideShadows) {
                ...
                (e || (e = we("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(p) - 0.5) / 0.5, 0), 1)));
              }
