/**
 * Story Share & Tags: copy-link and set share URLs for social buttons.
 * Uses data-share-url or current page; per-button data-link-* overrides.
 */
(function () {
  ...
  function run() {
    document.querySelectorAll('.story-share-tags').forEach(init);
  }
