...
use Drupal\Core\Url;
use Drupal\custom_field\Plugin\CustomField\FieldFormatter\UriLinkFormatter;
...
/**
 * Plugin implementation of the 'linkit_url' formatter for uri fields.
 */
#[FieldFormatter(
  id: 'linkit_url',
...
class LinkitUrlFormatter extends UriLinkFormatter {
  ...
  public function formatValue(FieldItemInterface $item, mixed $value): ?array {
    ...
    // Try to resolve the entity from the URI.
