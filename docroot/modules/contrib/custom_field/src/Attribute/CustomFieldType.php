...
/**
 * Defines a CustomFieldType attribute.
 *
 * Additional attribute keys for field types can be defined in
 * hook_custom_field_info_alter().
 *
 * @ingroup field_types
 */
...
class CustomFieldType extends Plugin {
  ...
  /**
   * Constructs a CustomFieldType attribute.
   *
   * @param string $id
   *   The plugin ID.
   ...
   *   (optional) A boolean stating that empty value can cause parent field to
   *   be considered empty.
   * @param bool $never_check_empty
   *   (optional) A boolean stating that this field type can never cause parent
   *   field to be considered empty.
   */
  public function __construct(
    public readonly string $id,
    public readonly TranslatableMarkup $label,
    public readonly TranslatableMarkup|array|null $description = NULL,
    public readonly TranslatableMarkup|null $category = NULL,
    ...
    public readonly bool $check_empty = FALSE,
    public readonly bool $never_check_empty = FALSE,
  ) {
  }
