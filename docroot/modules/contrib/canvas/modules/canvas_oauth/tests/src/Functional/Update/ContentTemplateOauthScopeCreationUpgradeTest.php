...
/**
 * Tests Canvas Oauth scope for content templates is created.
 *
 * @legacy-covers \canvas_oauth_post_update_0005_canvas_content_template_scope
 */
#[RunTestsInSeparateProcesses]
#[Group('canvas_oauth')]
final class ContentTemplateOauthScopeCreationUpgradeTest extends CanvasUpdatePathTestBase {

  protected $defaultTheme = 'stark';

  private const string SCOPE_ID = 'canvas_content_template';
  ...
  /**
   * Tests scope for content templates is created.
   */
