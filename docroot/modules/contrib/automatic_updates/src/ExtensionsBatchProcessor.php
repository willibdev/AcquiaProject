 ...
 */
final class ExtensionsBatchProcessor {
   ...
   *
   * @return \Drupal\automatic_updates\ExtensionUpdateSandboxManager
   ...
   *   The current context of the batch job.
   *
   * @see \Drupal\automatic_updates\ExtensionUpdateSandboxManager::begin()
   */
   ...
   *   The current context of the batch job.
   *
   * @see \Drupal\automatic_updates\ExtensionUpdateSandboxManager::apply()
   */
   ...
   *   The current context of the batch job.
   *
   * @see \Drupal\automatic_updates\ExtensionUpdateSandboxManager::destroy()
   */
  ...
  public static function finishStage(bool $success, array $results, array $operations): ?RedirectResponse {
    if ($success) {
      $stage_id = \Drupal::service('session')->get(static::STAGE_ID_SESSION_KEY);
      $url = Url::fromRoute('automatic_updates.extensions_confirmation_page', [
        'stage_id' => $stage_id,
      ]);
