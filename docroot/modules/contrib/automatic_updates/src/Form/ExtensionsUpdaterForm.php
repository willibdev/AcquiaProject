...
use Drupal\automatic_updates\ExtensionsBatchProcessor;
 ...
 */
final class ExtensionsUpdaterForm extends UpdateFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['projects'] = [
      ...
      '#required' => TRUE,
      '#required_error' => $this->t('Select one or more projects.'),
    ];
    ...
    if ($update_projects && $security_level !== RequirementSeverity::Error->value) {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch = (new BatchBuilder())
      ...
      ->addOperation(
        [ExtensionsBatchProcessor::class, 'begin'],
        [$selected_versions]
      )
      ->addOperation([ExtensionsBatchProcessor::class, 'stage'])
      ->setFinishCallback([ExtensionsBatchProcessor::class, 'finishStage'])
      ->toArray();
