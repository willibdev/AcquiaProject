 ...
 */
final class ExtensionsUpdateReady extends UpdateFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $batch = (new BatchBuilder())
      ...
      ->addOperation([ExtensionsBatchProcessor::class, 'commit'], [$stage_id])
      ->addOperation([ExtensionsBatchProcessor::class, 'postApply'], [$stage_id])
      ->addOperation([ExtensionsBatchProcessor::class, 'clean'], [$stage_id])
      ->setFinishCallback([ExtensionsBatchProcessor::class, 'finishCommit'])
      ->toArray();
